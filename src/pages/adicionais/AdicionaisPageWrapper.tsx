...
const TABS = [
  { path: '/adicionais/contratos', label: 'Contratos' },
  { path: '/adicionais/vinculos', label: 'Vínculos' },
  { path: '/adicionais/calendario', label: 'Calendário' },
  { path: '/adicionais/relatorio', label: 'Relatório' },
  { path: '/adicionais/importar-ponto', label: 'Importar Ponto' },
]

interface AdicionaisPageWrapperProps {
  children: React.ReactNode
  className?: string
}

export function AdicionaisPageWrapper({ children, className }: AdicionaisPageWrapperProps) {
...
export function AdicionaisCard({ children, title, description, className }: AdicionaisCardProps) {
  return (
    <div
...
interface AdicionaisButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children: React.ReactNode
  variant?: 'primary' | 'outline' | 'danger'
  size?: 'sm' | 'default' | 'lg'
}

export function AdicionaisButton({ children, variant = 'primary', size = 'default', className, ...props }: AdicionaisButtonProps) {
  return (
    <button
      className={cn(
