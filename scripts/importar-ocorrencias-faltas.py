# -*- coding: utf-8 -*-
"""
Importa ocorrências da planilha OCO_Funcionarios_160726 FALTAS tratada_final.xlsx.
...
# Configurações
ARQUIVO = Path('public/OCO_Funcionarios_160726 FALTAS tratada_final.xlsx')
ABA = 'Plan1'
