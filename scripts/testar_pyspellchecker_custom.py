...
spell.word_frequency.load_dictionary('scripts/pt_BR_spellchecker.json')
print('Palavras no dicionário customizado:', len(spell.word_frequency.dictionary))

# Verifica palavras
for p in ['insubordinação', 'advertido', 'faltado', 'desídia', 'com', 'trabalho', 'serviço', 'horário', 'justificativa', 'monitoramento']:
